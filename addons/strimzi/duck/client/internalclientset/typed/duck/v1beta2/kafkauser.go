...
import (
	...
	"github.com/twix14/k8s-addons/addons/strimzi/duck/client/internalclientset/scheme"
...
type KafkaUserInterface interface {
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.KafkaUser, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.KafkaUserList, error)
...
func (c *kafkaUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.KafkaUser, err error) {
	result = &v1beta2.KafkaUser{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kafkaUsers").
		Name(name).
...
func (c *kafkaUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.KafkaUserList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.KafkaUserList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kafkaUsers").
